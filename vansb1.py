# -*- coding: utf-8 -*- 
import BLACKROSESTEAM
from BLACKROSESTEAM import *
from vansbot.ttypes import *
...
cl = LineClient(authToken='EF8TSDMpnWJ7qzzuFnS7.TiS76xDGJgn3CGyWnG5QLW.7dD77HGGSM3XpjuX/owB9CWAA9AWbA3bq9srGVgZ9GE=')
...
poll = LinePoll(cl)
call = cl
creator = ["ub48b3be977608c6377720630360e6a97"]
owner = ["ub48b3be977608c6377720630360e6a97"]
admin = ["ub48b3be977608c6377720630360e6a97"]
staff = ["ub48b3be977608c6377720630360e6a97"]
lineProfile = cl.getProfile()
mid = cl.getProfile().mid
KAC = [cl]
Bots = ["u9a4384ac1d25e264044659bfddea224c"]
Saints = admin + staff
...
def help():
    ...
    key = key.title()
    helpMessage = "🚫❂͜͡➣ " + key + " [⚠️BLACKROSESTEAM~ⒷⓄⓣ]\n" + \
                   "🚫❂͜͡➣" + key + "✰BLACKROSESTEAM✰\n" + \
                  "🚫❂͜͡➣ " + key + "ʜᴇʟᴘ\n" + \
                  "🚫❂͜͡➣ " + key + "ʜᴇʟᴘ1\n" + \
                  "🚫❂͜͡➣ " + key + "ʜᴇʟᴘ2\n" + \
                   "🚫❂͜͡➣" + key + "ʜᴇʟᴘ3\n" + \
...
def help1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "🚫❂͜͡➣ " + key + " [⚠️BLACKROSESTEAM~ⒷⓄⓣ]\n" + \
                  "🚫❂͜͡➣ " + key + "ᴛᴀɢᴀʟʟ/ɴᴀʜ\n" + \
                  "🚫❂͜͡➣ " + key + "ɢɪɴғᴏ\n" + \
                  "🚫❂͜͡➣ " + key + "ᴏᴘᴇɴ\n" + \
                  "🚫❂͜͡➣ " + key + "ᴄʟᴏsᴇ\n" + \
                  ...
                  "🚫❂͜͡➣ " + key + "sᴘᴀᴍᴄᴀʟʟ:「ᴊᴜᴍʟᴀʜɴʏᴀ」\n" + \
                   ...
                   "「🚫 ]   ʙʏ: VansChester「⚠️] \n" + \
                   "  Creator:  line.me/ti/p/~indahcintaku19"
...
def help2():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage2= "      「✭SETTING BLACKROSESTEAM-BOT✭」\n" + \
                  "「🚫」 " + key + "ɪɴᴠɪᴛᴇ「ᴏɴ/ᴏғғ」\n" + \
                  "「🚫」 " + key + "sᴛɪᴄᴋᴇʀ「ᴏɴ/ᴏғғ」\n" + \
                  "「🚫」 " + key + "ᴜɴsᴇɴᴅ「ᴏɴ/ᴏғғ」\n" + \
                  "「🚫」 " + key + "sɪᴅᴇʀ「ᴏɴ/ᴏғғ」\n" + \
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                        ...
                        elif cmd == "BRT-bot" or cmd == "brtbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[⚠️ BLACKROSESTEAM~ⒷⓄⓣ].")
                               elapsed_time = time.time() - start
